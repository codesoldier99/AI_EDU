...
def register(app: App) -> None:
    ...
    def config(req: Request):
        ...
        return {
            ...
            "verify_gap_days": t.verify_gap_days,
            "retention_halflife_days": t.retention_halflife_days,
            "retention_threshold": t.retention_threshold,
            "keyword_pass_ratio": t.keyword_pass_ratio,
            "keyword_fail_ratio": t.keyword_fail_ratio,
            "groundedness_threshold": t.groundedness_threshold,
